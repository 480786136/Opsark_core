  ...
  <details class="advanced-parameters">
    ...
    <div class="advanced-body">
      ...
      <div class="parameter-grid">
        ...
        <label><span class="parameter-label">reasoning_effort <span class="parameter-help" tabindex="0" :data-tip="help.reasoning_effort">?</span></span><ParameterSelect :model-value="values.reasoning_effort ?? ''" :options="optionSets.reasoning_effort" :ariaLabel="'reasoning_effort'" @update:model-value="updateValue('reasoning_effort', $event)"/></label>
        <label><span class="parameter-label">thinking <span class="parameter-help" tabindex="0" :data-tip="help.thinking">?</span></span><ParameterSelect :model-value="values.thinking ?? ''" :options="optionSets.thinking" :ariaLabel="'thinking'" @update:model-value="updateValue('thinking', $event)"/></label>
      </div>
