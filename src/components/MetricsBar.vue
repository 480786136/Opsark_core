...
<template>
  <footer class="metrics-bar">
    ...
    <div class="network-metric"><Database :size="14" /><span>{{ t("metrics.network") }}</span><ArrowDown :size="12" /><strong>{{ store.metrics.networkIn }} MB/s</strong><ArrowUp :size="12" /><strong>{{ store.metrics.networkOut }} MB/s</strong></div>
