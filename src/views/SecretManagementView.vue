...
async function deleteEntry() {
  ...
  const message = editing.value.credentialGroupId
    ? t("settings.deleteCredentialGroupConfirm")
    : t("settings.deleteSecretConfirm");
